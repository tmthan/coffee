...
$sql = "UPDATE `chi_tiet_hoa_don` SET `Trang_Thai_Nau`= 0,`Nguoi_Nau`= '$nguoiNau' WHERE `Ma_Chi_Tiet` = $maChiTiet;";
...
$sql = "INSERT INTO `trang_thai`( `Ten_Dang_Nhap`, `Thoi_Gian_Trang_Thai`, `Noi_Dung_Trang_Thai`) VALUES ('$nguoiNau','$thoiGianNau','Đã hủy pha chế $tenMon của $tenBan');";
