...
<div class="menu">  
  <div class="right">
    <span id="thungan" style="cursor: pointer;"><i class="fas fa-money-check-alt"></i> Thu ngân</span>
    <span id="taikhoan" style="cursor: pointer;"><i class="fas fa-user" title="Tài khoản" id="taikhoan"></i> Tài khoản</span>
    <a href="dangxuat.php">
    	<i class="fas fa-power-off" title="Đăng xuất"></i> Đăng xuất          
    </a>
  </div>
				...
				$(document).ready(function(){
					$('#doimatkhau').click(function(){	
						...
						if (!patpass.test(matKhauMoi) || !patpass.test(nhapLaiMatKhauMoi)) {
							...
							$.ajax({
							    url: 'thungan/doimatkhau-load.php',
								type: 'POST',
		        				dataType: 'text',
								data: {
