...
<div class="block-header">
    <h2>Lịch sử nhập/xuất/tồn đồ uống</h2>
</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#noidunglichsukho').load('thungan/luukho/lichsukhohomnay.php');

		$('#xemlichsukho').click(function(){
			var thoiGianBatDau = $("#thoigianbatdau").val();
			var thoiGianKetThuc = $("#thoigianketthuc").val();
			$('#noidunglichsukho').load('thungan/luukho/lichsukhotuychon.php?thoigianbatdau=' + thoiGianBatDau + '&thoigianketthuc=' + thoiGianKetThuc);
		})
