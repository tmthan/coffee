			...
			<div class="body">
				<div class="row clearfix">
					...
					<div class="col-md-2 col-sm2 col-xs-4">
						<label> &nbsp</label>
						<br>
						<button class="btn btn-default" id="thongketuychon">Xem</button>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#noidungthongke').load('quanly/thongke/thongkehomnay.php');

		$('#thongketuychon').click(function(){
			var thoiGianBatDau = $("#thoigianbatdau").val();
			var thoiGianKetThuc = $("#thoigianketthuc").val();
			$('#noidungthongke').load('quanly/thongke/thongketuychon.php?thoigianbatdau=' + thoiGianBatDau + '&thoigianketthuc=' + thoiGianKetThuc);
		})
