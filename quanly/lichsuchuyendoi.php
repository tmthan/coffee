				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md2 col-sm-2 col-xs-4">
							<label>&nbsp</label>
							<br>
							<button class="btn btn-default" id="xemlichsuchuyendoi">Xem</button>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#noidunglichsuchuyendoi').load('quanly/chuyendoihanghoa/lichsuchuyendoihomnay.php');

		$('#xemlichsuchuyendoi').click(function(){
			var thoiGianBatDau = $("#thoigianbatdau").val();
			var thoiGianKetThuc = $("#thoigianketthuc").val();
			$('#noidunglichsuchuyendoi').load('quanly/chuyendoihanghoa/lichsuchuyendoituychon.php?thoigianbatdau=' + thoiGianBatDau + '&thoigianketthuc=' + thoiGianKetThuc);
		})
