...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#noidunglichsukho').load('quanly/luukhohang/lichsukhohomnay.php');

		$('#xemlichsukho').click(function(){
			var thoiGianBatDau = $("#thoigianbatdau").val();
			var thoiGianKetThuc = $("#thoigianketthuc").val();
			$('#noidunglichsukho').load('quanly/luukhohang/lichsukhotuychon.php?thoigianbatdau=' + thoiGianBatDau + '&thoigianketthuc=' + thoiGianKetThuc);
		})
